import type { SignUpValidationErrorsFragmentFragment } from "./SignUpForm.graphql.generated"
...
export function getFormErrorsFromSignUpValidationErrors(validationErrors: SignUpValidationErrorsFragmentFragment) {
	const fieldErrors: Record<Exclude<keyof SignUpFormValues, "secret">, string | undefined> = {
		email: getEmailFieldErrorMessage(validationErrors),
		fname: getFirstNameFieldErrorMessage(validationErrors),
		lname: getLastNameFieldErrorMessage(validationErrors),
