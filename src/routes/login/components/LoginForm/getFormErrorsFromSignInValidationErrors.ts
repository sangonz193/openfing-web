import type { SignInValidationErrorsFragmentFragment } from "./LoginForm.graphql.generated"
...
export function getFormErrorsFromSignInValidationErrors(validationErrors: SignInValidationErrorsFragmentFragment) {
	const fieldErrors: Record<Exclude<keyof LoginFormValues, "secret">, string | undefined> = {
