...
import { CLOSE_CIRCLE_OUTLINE_ICON_NAME } from "../Icon/close-circle-outline.generated"
...
const FileInputComponent: React.FC<FileInputProps> = ({ className, label, value, errorMessage, onChange }) => {
	...
	const renderClearIcon = React.useCallback(() => {
		return (
			<CommandBarButton
				iconProps={{ iconName: CLOSE_CIRCLE_OUTLINE_ICON_NAME, className: styles.clearIcon }}
