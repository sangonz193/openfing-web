...
export type CourseClassByIdQuery = { __typename?: 'Query', courseClassById: { __typename: 'CourseClass', id: string, name: Types.Maybe<string>, publishedAt: Types.Maybe<string>, videos: Array<{ __typename?: 'CourseClassVideo', id: string, name: Types.Maybe<string>, qualities: Array<{ __typename?: 'CourseClassVideoQuality', id: string, formats: Array<{ __typename?: 'CourseClassVideoFormat', id: string, name: Types.Maybe<string>, url: Types.Maybe<string> }> }> }>, chapterCues: Array<{ __typename?: 'CourseClassChapterCue', id: string, name: string, startSeconds: number, endSeconds: number, courseClass: Types.Maybe<{ __typename?: 'CourseClass', id: string }> }> } | { __typename: 'NotFoundError' } };
